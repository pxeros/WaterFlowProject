...
public class WaterFlowVisualization extends Applet {
    ...
    WaterFlowVisualization(WaterFlow waterFlow) {
        this.delayTimeGrid = waterFlow.delayTimeGrid;
        this.reachTimeGrid = waterFlow.reachTimeGrid;
        this.rows = waterFlow.rows;
        this.columns = waterFlow.columns;
        this.getEarliestPathGrid = waterFlow.earliestPathGrid;
    }
